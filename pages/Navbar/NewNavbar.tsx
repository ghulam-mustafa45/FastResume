...
<div className='bg-white border-b-[1px] border-gray-200'>
    ...
    <div className='inline-flex space-x-2 cursor-pointer'  style={{ alignItems: 'center' }}>
             <div className={`inline-flex space-x-2 cursor-pointer ${activeTab === 1 ? ' ring-blue-500 text-blue-700'  : ''}`} onClick={() => handleTabClick(1)} style={{ alignItems: 'center' }}>
            ...
            <div className= {`inline-flex space-x-2 cursor-pointer ${activeTab === 2 ? ' ring-blue-500 text-blue-700'  : ''}`} style={{ alignItems: 'center' }}  onClick={() => handleTabClick(2)}>
            ...
            <div className={`inline-flex space-x-2 cursor-pointer ${activeTab === 3 ? ' ring-blue-500 text-blue-700'  : ''}`}  style={{ alignItems: 'center' }} onClick={() => handleTabClick(3)}>
            <div className='inline-flex space-x-2' style={{ alignItems: 'center' }}>
            ...
            <div className={`inline-flex space-x-2 cursor-pointer ${activeTab === 4 ? ' ring-blue-500 text-blue-700'  : ''}`}  style={{ alignItems: 'center' }} onClick={() => handleTabClick(4)}>
            <div className='inline-flex space-x-2' style={{ alignItems: 'center' }}>
            ...
            <div className={`inline-flex space-x-2 cursor-pointer ${activeTab === 5 ? ' ring-blue-500 text-blue-700'  : ''}`}  style={{ alignItems: 'center' }} onClick={() => handleTabClick(5)}>
            <div className='inline-flex space-x-2' style={{ alignItems: 'center' }}>
